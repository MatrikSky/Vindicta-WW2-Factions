...
/*Vest*/
this addVest "fow_v_us_carbine_eng";
/*Backpack*/
...
/*WeaponItem*/
this addPrimaryWeaponItem "fow_6Rnd_12G_Slug";

/*Items*/
this addItemToBackpack "LIB_ToolKit";
for "_i" from 1 to 2 do {this addItemToVest "fow_6Rnd_12G_Slug";};
for "_i" from 1 to 3 do {this addItemToVest "fow_6Rnd_12G_Pellets";};
