...
this addPrimaryWeaponItem "LIB_M1918A2_BAR_Handle";
/*WeaponItem*/
this addPrimaryWeaponItem "lib_20rnd_762x63";

/*Items*/
for "_i" from 1 to 4 do {this addItemToVest "lib_20rnd_762x63";};
