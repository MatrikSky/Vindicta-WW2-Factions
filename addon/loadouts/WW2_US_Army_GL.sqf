...
/*WeaponItem*/
this addPrimaryWeaponItem "LIB_ACC_GL_M7";
this addPrimaryWeaponItem "lib_8rnd_762x63";
this addPrimaryWeaponItem "LIB_1Rnd_G_Mk2";

/*Items*/
this addItemToVest "LIB_ACC_M1_Bayo";
for "_i" from 1 to 5 do {this addItemToVest "lib_8rnd_762x63";};
for "_i" from 1 to 2 do {this addItemToVest "LIB_1Rnd_G_Mk2";};
for "_i" from 1 to 2 do {this addItemToVest "LIB_1Rnd_G_M9A1";};
