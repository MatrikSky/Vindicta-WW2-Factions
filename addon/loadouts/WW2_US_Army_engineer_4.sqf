...
/*Backpack*/
this addBackpack "B_LIB_US_M2Flamethrower";

/*Weapon*/
this addWeapon "LIB_M2_Flamethrower";
this addWeapon "LIB_Colt_M1911";
/*WeaponItem*/
this addPrimaryWeaponItem "lib_m2_flamethrower_mag";
this addHandgunItem "LIB_7Rnd_45ACP";

/*Items*/
this addItemToBackpack "lib_m2_flamethrower_mag";
for "_i" from 1 to 4 do {this addItemToVest "LIB_7Rnd_45ACP";};
