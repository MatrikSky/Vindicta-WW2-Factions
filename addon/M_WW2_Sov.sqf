...
_inf set [T_INF_rifleman, ["WW2_Sov_rifleman", 2, "WW2_Sov_rifleman_2", 1.25, "WW2_Sov_rifleman_3", 0.75, "WW2_Sov_rifleman_4", 2, "WW2_Sov_rifleman_5", 2]];
_inf set [T_INF_sniper, ["WW2_Sov_sniper"]];
_inf set [T_INF_marksman, ["WW2_Sov_marksman"]];
_inf set [T_INF_exp, ["WW2_Sov_explosives"]];
_inf set [T_INF_LAT, ["WW2_Sov_LAT", "WW2_Sov_LAT_2", "WW2_Sov_LAT_3"]];
_inf set [T_INF_AT, ["WW2_Sov_AT", "WW2_Sov_AT_2"]];
_inf set [T_INF_LMG, ["WW2_Sov_LMG"]];
_inf set [T_INF_HMG, ["WW2_Sov_HMG"]];
_inf set [T_INF_medic, ["WW2_Sov_medic", "WW2_Sov_medic_2", "WW2_Sov_medic_3"]];
...
_inf set [T_INF_ammo, ["WW2_Sov_ammo", "WW2_Sov_ammo_2", "WW2_Sov_ammo_3"]];
_inf set [T_INF_survivor, ["WW2_Sov_unarmed"]];
_inf set [T_INF_unarmed, ["WW2_Sov_unarmed"]];
_inf set [T_INF_pilot_heli, ["WW2_Sov_pilot"]];
_inf set [T_INF_crew_heli, ["WW2_Sov_pilot"]];
_inf set [T_INF_AA, ["WW2_Sov_TL"]];
